...
TForm1 *Form1;
	...
	char p1,p2,p3,p4,p5,p6,p7,p8,p9; // p1..p9 pola w grze(ich zawartosc: p1='n'; nic lib 'x' lub 'o')
	char kto; // czyja tura - 'x' lub 'o';
	...
	void sprawdz()
	{
		if((p1==p2 && p2==p3 && p1!='n') ||
		  ...
		  (p3==p5 && p5==p7 && p5!='n'))
		  {
			  if (kto=='x') Application->MessageBox(L"Wygrywa kó³ko!", L"Koniec gry", MB_OK);
			  else Application->MessageBox(L"Wygrywa krzy¿yk!", L"Koniec gry", MB_OK);
		  ...
		  (p9 != 'n'))
		  {
			   Application->MessageBox(L"Remis!", L"Koniec gry", MB_OK);
		  }
